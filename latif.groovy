job('latif-Via-DSL') { 
    ...
    steps {
        ...
        maven {
            ...
            rootPOM('5-Deployment-jenkins-and-Java-tomcat-sample-main/pom.xml')  // yukaridaki 4. satir ile baglantili #### Ve calistiii :D:D:D:D:D
            // rootPOM('pom.xml')
        }
    }
    publishers {
...
// Bu Web sayfasindan gerekli yardimi aldik. :D
